...
describe("Test of RollUp Contract", () => {
    ...
    it("Test of Add BlockHeader height 1", async () => {
        ...
        assert.deepStrictEqual(res[2], "0xb10edf5e825d5be4dca9a2d432ed2a997e391f70f109c4410ee0b966a83de995");
    ...
    it("Test of Get by BlockHashs", async () => {
        ...
        ).to.be.revertedWith("E004: No corresponding block hash key value.");
    });
});
